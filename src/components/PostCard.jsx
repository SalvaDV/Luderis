    ...
    <div onClick={()=>onOpenDetail(post)} className="cl-card-anim"
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10,gap:8}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:6,flexShrink:0}}>
          ...
          {esMio&&(
            <div style={{background:T.accent,color:"#fff",borderRadius:20,padding:"3px 9px",fontSize:9,fontWeight:800,display:"flex",alignItems:"center",gap:3,boxShadow:`0 2px 8px ${T.accent}50`,letterSpacing:.5,textTransform:"uppercase",flexShrink:0}}>
