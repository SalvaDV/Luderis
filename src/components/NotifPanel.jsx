...
export default function NotifPanel({session,open,onClose,onOpenDetail,onOpenCurso}){
  ...
  const TIPO_INFO={
    ...
    alerta_contacto:  {Icon:VolumeX,      color:"#E53E3E",label:"Mensaje con datos de contacto detectado"},
    nueva_pregunta:   {Icon:HelpCircle,   color:"#1A6ED8",label:"Nueva pregunta en tu publicación"},
    pregunta_respondida:{Icon:CheckCircle,color:"#2EC4A0",label:"Tu pregunta fue respondida"},
