  ...
  return(
    <div style={{background:C.surface,border:`1px solid ${ofertasPendientes>0?C.accent+"60":C.border}`,borderRadius:10,padding:"16px 18px",fontFamily:FONT,transition:"box-shadow .15s"}}
      ...
      <div style={{display:"flex",justifyContent:"space-between",gap:10,alignItems:"flex-start"}}>
        <div style={{flex:1,minWidth:0}}>
          {/* Badges */}
          <div style={{display:"flex",gap:5,flexWrap:"wrap",marginBottom:8,alignItems:"center",minWidth:0}}>
            <Tag tipo={post.tipo}/>
        ...
        {/* Acciones verticales */}
        <div style={{display:"flex",flexDirection:"row",flexWrap:"wrap",gap:5,flexShrink:0,maxWidth:200,alignItems:"flex-start",justifyContent:"flex-end"}}>
          {post.tipo==="oferta"&&(
