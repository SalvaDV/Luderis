  ...
  return(
    <div style={{minHeight:"100vh",background:"#F6F9FF",fontFamily:FONT,overflowX:"hidden"}}>
      <style>{`
        ...
        .ld-logo{animation:floatY 4s ease-in-out infinite}
        .ld-card:hover{transform:translateY(-4px);box-shadow:0 12px 40px rgba(26,110,216,.12)!important}
        .ld-card{transition:transform .25s,box-shadow .25s}
      ...
      {/* ── NAV ── */}
      <nav style={{position:"sticky",top:0,zIndex:50,background:"rgba(246,249,255,.9)",backdropFilter:"blur(12px)",borderBottom:"1px solid rgba(26,110,216,.1)",padding:"0 32px",height:64,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <img src="/logo.png" alt="Luderis" style={{width:34,height:34,objectFit:"contain"}} className="ld-logo"/>
          <span style={{fontWeight:800,fontSize:20,background:LUD.grad,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"-.3px"}}>Luderis</span>
        </div>
        <button onClick={onEnter}
          style={{background:LUD.grad,border:"none",borderRadius:20,color:"#fff",padding:"9px 22px",fontWeight:600,fontSize:14,cursor:"pointer",fontFamily:FONT,boxShadow:"0 4px 14px rgba(26,110,216,.3)"}}>
          Ingresar →
        </button>
      </nav>

      {/* ── HERO ── */}
      <section style={{maxWidth:1100,margin:"0 auto",padding:"80px 32px 60px",display:"flex",alignItems:"center",gap:60,flexWrap:"wrap"}}>
        <div style={{flex:"1 1 400px",minWidth:0}}>
          <div className="ld-hero" style={{display:"inline-flex",alignItems:"center",gap:7,background:"rgba(26,110,216,.08)",border:"1px solid rgba(26,110,216,.2)",borderRadius:20,padding:"5px 14px",marginBottom:24}}>
          ...
          <h1 className="ld-hero" style={{fontSize:"clamp(36px,5vw,58px)",fontWeight:800,lineHeight:1.1,color:"#0D1F3C",margin:"0 0 20px",letterSpacing:"-1px"}}>
            Conectá docentes<br/>
            <span style={{background:LUD.grad,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>y estudiantes</span>
          </h1>
          <p className="ld-hero2" style={{fontSize:18,color:"#4A5568",lineHeight:1.7,margin:"0 0 36px",maxWidth:460}}>
            Encontrá clases particulares, cursos y docentes calificados. Sin intermediarios, sin comisiones.
          </p>
          <div className="ld-hero3" style={{display:"flex",gap:12,flexWrap:"wrap"}}>
            <button onClick={onEnter}
              ...
              style={{background:LUD.grad,border:"none",borderRadius:24,color:"#fff",padding:"14px 32px",fontWeight:700,fontSize:16,cursor:"pointer",fontFamily:FONT,
                boxShadow:hovBtn?"0 8px 28px rgba(26,110,216,.45)":"0 4px 18px rgba(26,110,216,.3)",
                transform:hovBtn?"translateY(-2px)":"none",transition:"all .2s"}}>
              Empezar gratis →
            </button>
            <button onClick={onEnter}
              style={{background:"transparent",border:"2px solid rgba(26,110,216,.25)",borderRadius:24,color:LUD.blue,padding:"14px 28px",fontWeight:600,fontSize:15,cursor:"pointer",fontFamily:FONT,transition:"border-color .2s"}}
              onMouseEnter={e=>e.currentTarget.style.borderColor=LUD.blue}
              onMouseLeave={e=>e.currentTarget.style.borderColor="rgba(26,110,216,.25)"}>
              Ver clases disponibles
            </button>
          </div>
        </div>
        {/* Ilustración con orbes animados */}
        <div style={{flex:"0 0 340px",position:"relative",height:340,display:"flex",alignItems:"center",justifyContent:"center"}}>
          {/* Orbes de fondo */}
          <div className="ld-orb1" style={{position:"absolute",width:200,height:200,borderRadius:"50%",background:"rgba(26,110,216,.06)",top:20,left:20}}/>
          <div className="ld-orb2" style={{position:"absolute",width:140,height:140,borderRadius:"50%",background:"rgba(46,196,160,.08)",bottom:30,right:10}}/>
          <div className="ld-orb3" style={{position:"absolute",width:80,height:80,borderRadius:"50%",background:"rgba(26,110,216,.1)",top:10,right:40}}/>
          {/* Logo grande central */}
          <div style={{position:"relative",zIndex:1,width:160,height:160,background:"#fff",borderRadius:32,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 20px 60px rgba(26,110,216,.18)",animation:"floatY 4s ease-in-out infinite"}}>
            <img src="/logo.png" alt="Luderis" style={{width:110,height:110,objectFit:"contain"}}/>
          </div>
          {/* Chips flotantes */}
          {[
            {label:"✓ Clases verificadas",top:20,left:-20,delay:"0s"},
            {label:"★ 4.9 promedio",bottom:50,right:-30,delay:".8s"},
            {label:"🤖 Búsqueda con IA",top:60,right:-40,delay:"1.4s"},
          ].map(c=>(
            <div key={c.label} style={{position:"absolute",top:c.top,bottom:c.bottom,left:c.left,right:c.right,background:"#fff",borderRadius:20,padding:"8px 14px",fontSize:12,fontWeight:600,color:"#0D1F3C",boxShadow:"0 6px 20px rgba(0,0,0,.08)",whiteSpace:"nowrap",animation:`floatY 4s ${c.delay} ease-in-out infinite`}}>
              {c.label}
            </div>
          ))}
        </div>
      ...
      <section style={{maxWidth:1100,margin:"0 auto 80px",padding:"0 32px"}}>
        <div style={{textAlign:"center",marginBottom:48}}>
          <h2 style={{fontSize:32,fontWeight:800,color:"#0D1F3C",margin:"0 0 12px",letterSpacing:"-.5px"}}>Todo lo que necesitás</h2>
          <p style={{color:"#4A5568",fontSize:16,margin:0}}>Una plataforma pensada para el aprendizaje real</p>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))",gap:20}}>
          {[
            {icon:"🎯",title:"Clases particulares",desc:"Encontrá docentes disponibles para tu tema y horario, con precios transparentes.",color:"rgba(26,110,216,.08)",border:"rgba(26,110,216,.15)"},
            {icon:"📚",title:"Cursos completos",desc:"Cursos con contenido, evaluaciones y certificados. Síncronos y asíncronos.",color:"rgba(46,196,160,.08)",border:"rgba(46,196,160,.2)"},
            {icon:"🤖",title:"Búsqueda con IA",desc:"Describí lo que necesitás y la IA encuentra las mejores opciones para vos.",color:"rgba(124,58,237,.08)",border:"rgba(124,58,237,.15)"},
            {icon:"📊",title:"Seguimiento real",desc:"Evaluaciones, notas, habilidades y progreso del alumno en un solo lugar.",color:"rgba(245,158,11,.08)",border:"rgba(245,158,11,.2)"},
          ].map(f=>(
            <div key={f.title} className="ld-card"
              style={{background:"#fff",border:`1px solid ${f.border}`,borderRadius:16,padding:"28px 24px",boxShadow:"0 2px 12px rgba(0,0,0,.04)"}}>
              <div style={{width:52,height:52,borderRadius:14,background:f.color,display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,marginBottom:16}}>{f.icon}</div>
              <h3 style={{fontWeight:700,color:"#0D1F3C",fontSize:17,margin:"0 0 8px"}}>{f.title}</h3>
              <p style={{color:"#4A5568",fontSize:14,lineHeight:1.6,margin:0}}>{f.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* ── CTA FINAL ── */}
      <section style={{margin:"0 32px 80px",borderRadius:24,background:LUD.gradDark,padding:"60px 40px",textAlign:"center",position:"relative",overflow:"hidden",maxWidth:1036,marginLeft:"auto",marginRight:"auto"}}>
        <div style={{position:"absolute",width:300,height:300,borderRadius:"50%",background:"rgba(255,255,255,.04)",top:-80,right:-80}}/>
        <div style={{position:"absolute",width:200,height:200,borderRadius:"50%",background:"rgba(255,255,255,.04)",bottom:-60,left:-40}}/>
        <div style={{position:"relative",zIndex:1}}>
          <img src="/logo.png" alt="Luderis" style={{width:64,height:64,objectFit:"contain",marginBottom:20,filter:"brightness(0) invert(1)",opacity:.9}}/>
          <h2 style={{color:"#fff",fontSize:34,fontWeight:800,margin:"0 0 14px",letterSpacing:"-.5px"}}>Empezá hoy, es gratis</h2>
          <p style={{color:"rgba(255,255,255,.75)",fontSize:16,margin:"0 0 32px"}}>Registrate en segundos y conectá con docentes o estudiantes.</p>
          <button onClick={onEnter}
            style={{background:"#fff",border:"none",borderRadius:24,color:LUD.blue,padding:"14px 36px",fontWeight:700,fontSize:16,cursor:"pointer",fontFamily:FONT,boxShadow:"0 8px 24px rgba(0,0,0,.2)"}}>
            Crear cuenta gratis →
          </button>
        </div>
      </section>
      ...
      {/* ── FOOTER ── */}
      <footer style={{borderTop:"1px solid rgba(26,110,216,.1)",padding:"28px 32px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12,maxWidth:1100,margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <img src="/logo.png" alt="Luderis" style={{width:24,height:24,objectFit:"contain"}}/>
          <span style={{fontWeight:700,fontSize:14,background:LUD.grad,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Luderis</span>
        </div>
...
function AuthScreen({onLogin}){
  ...
  const iS={width:"100%",background:"#F4F7FF",border:"1.5px solid #DDE5F5",borderRadius:10,padding:"12px 14px",color:"#0D1F3C",fontSize:14,outline:"none",boxSizing:"border-box",fontFamily:FONT,marginBottom:12,transition:"border-color .15s,background .15s"};
    ...
    <div style={{minHeight:"100vh",display:"flex",fontFamily:FONT,background:"#F6F9FF"}}>
      ...
      <div className="auth-left" style={{flex:"0 0 380px",background:"linear-gradient(160deg,#0A2A5E 0%,#1A6ED8 55%,#2EC4A0 100%)",display:"flex",flexDirection:"column",padding:"48px 40px",position:"relative",overflow:"hidden",justifyContent:"space-between"}}>
        ...
        <div style={{position:"relative",zIndex:1}}>
          ...
          <h2 style={{color:"#fff",fontSize:30,fontWeight:800,lineHeight:1.2,margin:"0 0 14px",letterSpacing:"-.5px"}}>
            Aprendé y enseñá sin límites
          </h2>
          <p style={{color:"rgba(255,255,255,.7)",fontSize:14,lineHeight:1.75,margin:0}}>
            La plataforma donde docentes y estudiantes se encuentran. Sin intermediarios ni comisiones.
          </p>
        </div>
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"32px 24px"}}>
        <div style={{width:"min(420px,100%)",animation:"fadeSlideUp .5s ease both"}}>
          ...
          {/* Logo mobile */}
          <div className="auth-logo-mobile" style={{alignItems:"center",gap:10,marginBottom:32,justifyContent:"center"}}>
