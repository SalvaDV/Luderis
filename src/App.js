...
const THEMES={
  ...
  light:{bg:"#F4F4F0",surface:"#FFFFFF",card:"#FAFAF7",border:"#E2E2DC",accent:"#C8960A",accentDim:"#C8960A18",text:"#18180F",muted:"#888",success:"#2A8A45",danger:"#C0392B",sidebar:"#ECECEA",info:"#2471A3",purple:"#8E44AD",warn:"#B7770D"},
};
